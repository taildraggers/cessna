"""Scrape classic Cessna taildragger listings from Barnstormers.com and
render them into docs/index.html for embedding via <iframe> on
taildraggers.com. Only specific models are kept - see
scraper/barnstormers.py's TARGET_MODEL_PHRASES.
"""
...
<body>
  ...
  <div class="more-resources">
    <h2>Search More Cessna Listings</h2>
    <p>View additional Cessna Aircraft listings at these fine sites:</p>
